...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=1000&color=05cbf7&center=true&vCenter=true&width=435&lines=Hey!+I'm+Zean+Kurt+👋;Computer+Science+Student;Web+Developer;Blockchain+Enthusiast;Photographer;Videographer)](https://git.io/typing-svg)
...
- 🎯 Interested in **software optimization and system programming**  

---

### 🧩 Currently Working On
- Building small **Java projects** to strengthen OOP skills  
- Exploring **databases** and data handling concepts  
- Developing **mini web projects** to improve frontend and backend knowledge  

---

### 📌 Skills & Tools
[![My Skills](https://skillicons.dev/icons?i=java,html,js,ts,python,c,css,react,next,tailwind,discordjs,nodejs,eclipse,pycharm,vscode,idea,git,github,discord,replit&perline=10)](https://skillicons.dev)
